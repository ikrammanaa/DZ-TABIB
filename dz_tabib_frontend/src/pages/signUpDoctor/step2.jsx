...
import singupImag from "../../assets/project1.jpg";
  ...
  return( 
    <div className="flex flex-col lg:flex-row h-screen bg-blue2 bg-opacity-10">
      ...
      <img
        ...
        // Add onClick handler to navigate to homepage
      />
        ...
        <div className="flex justify-between">
          <button
            type="button"
            onClick={resendOTP}
            className="mr-10 px-8 py-4 bg-gradient-to-r from-ciel to-blue2 opacity-500 hover:bg-gray-400 text-white rounded-lg shadow-md hover:scale-105 hover:shadow-lg transition-transform text-sm"
          >
            Resend OTP
          </button>
          <button
            type="button"
            onClick={verifyOTP}
            className="ml-10 px-10 py-4 bg-gradient-to-r from-blue2 to-blue opacity-500 text-white rounded-lg shadow-md hover:scale-105 hover:shadow-lg transition-transform text-sm"
          >
            Verify OTP
          </button>
        </div>
      ...
      {/* Right Section */}
      <div className="s lg:w-1/2 relative">
        <img
          src={singupImag}
