...
import signupImage from "../../assets/project1.jpg";
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
          ...
          <div className="mb-4 relative">
            ...
            <button
              ...
              className="absolute mt-3 right-1 px-1  text-gray-600 hover:text-gray-800 focus:outline-none"
            >
              {passwordVisible ? (
          ...
          <button
            type="submit"
            className="w-full bg-gradient-to-r from-blue2 to-blue opacity-500 text-white py-2 px-4 rounded-lg hover:bg-blue-600 focus:ring-2 focus:ring-blue-400 focus:outline-none"
          >
            Sign up
          </button>
        </form>
